    ...
    <section>
      ...
      <div class="c-flex-col2 mt50">
        <div>
          ...
          <img class="mt30" src="<?php echo $imagePath ?>career/graduation/img01_shinrojokyo.jpg" alt="大学進学率91.9%、国公立を含む難関有名大学に72.3%が進学" width="555" height="352">
        </div>
        <div>
          <h2 class="c-secttl-box">4年制大学進学者内訳</h2>
          <img class="mt10" src="<?php echo $imagePath ?>career/graduation/img02_daigaku.jpg" alt="国公立8名、関関同立24名、産近甲龍56名、主要女子大71名、首都圏18名、医歯薬看護系74名、食物栄養系12名、芸術系12名" width="518" height="469">
        </div>
      </div><!-- /.c-flex-col2 -->
    </section>
